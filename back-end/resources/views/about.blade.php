...
@section('content')
    ...
    <div class="unit-5 overlay" style="background-color:#737373;">
      ...
      <div class="container">
        ...
        <div class="row team">
          <div class="col-lg-2 col-md-4 col-sm-6 col-12" data-aos="fade" data-aos-delay="100">
            <a href="#" class="person">
              <img src="images/per1.jpg" alt="Image placeholder">
              <h2>Yashveer Singh Sohi</h2>
              <p>CEO, Co-founder</p>
            </a>
          </div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12" data-aos="fade" data-aos-delay="600">
            <a href="#" class="person">
              <img src="images/per6.jpg" alt="Image placeholder">
              <h2>Naeem Patel</h2>
              <p>Chat Bot Developer</p>
            </a>
          </div>
        </div>
      </div>
